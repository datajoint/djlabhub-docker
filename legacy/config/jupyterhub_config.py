...
# c.JupyterHub.authenticator_class = os.getenv("JUPYTER_HUB_AUTHENTICATOR_CLASS", "jupyterhub.auth.DummyAuthenticator")
...
#  Default: '/home/drewyang/anaconda3/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/drewyang/anaconda3/share/jupyterhub'
...
# c.JupyterHub.spawner_class = os.getenv("JUPYTER_HUB_SPAWNER", "jupyterhub.spawner.LocalProcessSpawner")
...
# c.Spawner.default_url = os.getenv("JUPYTER_HUB_SPAWNER_DEFAULT_URL", "/lab")
...
# c.Spawner.ip = os.getenv("JUPYTER_HUB_SPAWNER_IP", "127.0.0.1")
